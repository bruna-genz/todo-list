        ...
        <div id="item-options">
            <div id="left-options">
                <div id="item-title">
                    ...
                    <h1><img src="assets/images/tick.svg" alt=""><input id="list-name-input" type="text" placeholder="Item title"></h1>
            ...
            <div id="right-options">
                ...
                <form id="checklist-title-form" class="hidden">
                    <p>Add Checklist <img id="checklist-close" src="assets/images/close.svg" alt=""></p>
